                            ...
                            <div class="header-wrapper-1">
                                <div class="logo-area-start">
                                    <a href="index.html" class="logo">
                                        <img src="{{asset('assets/images/logo/logo.svg')}}" alt="logo_area">
                                    </a>
                                </div>
                                    ...
                                    <div class="bottom d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="bottom-right">
                                            <div class="button-area">
                                                <a href="account.html" class="rts-btn btn-border radius-big icon">
                                                    Sign In
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <div class="about-content-area">
                                    ...
                                    <p class="desc">Welcome to Autovault where innovation drives every journey. Discover a
                                        range
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="feature-wrapper">
                                        <div class="image-area">
                                            <img src="assets/images/feature/slider-01.webp" width="961" alt="">
                                        </div>
                                        <div class="content-area">
                                            <span class="dot"></span>
                                            <h6 class="title"><a href="portfolio-details.html">Thunderbolt Car</a></h6>
                                            <ul class="feature-area">
                                                <li>
                                                    <img src="assets/images/portfolio/feature-icon/01.svg" alt="">
                                                    100 Miles
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-wrapper">
                                        <div class="image-area">
                                            <img src="assets/images/feature/slider-02.webp" width="961" alt="">
                                        </div>
                                        <div class="content-area">
                                            <span class="dot"></span>
                                            <h6 class="title"><a href="portfolio-details.html">Mazda MX-5 Miata</a></h6>
                                            <ul class="feature-area">
                                                <li>
                                                    <img src="assets/images/portfolio/feature-icon/01.svg" alt="">
                                                    100 Miles
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-wrapper">
                                        <div class="image-area">
                                            <img src="assets/images/feature/slider-03.webp" width="961" alt="">
                                        </div>
                                        <div class="content-area">
                                            <span class="dot"></span>
