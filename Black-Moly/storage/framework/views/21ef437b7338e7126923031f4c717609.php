    ...
    <div class="impl_sell_wrapper">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    <form id="impl_sform" action="<?php echo e(route('vehicle.sell')); ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <select id="model_id" name="model_id" class="form-control required">
                                                    ...
                                                    <?php $__currentLoopData = $carModels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carModel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($carModel->id); ?>"><?php echo e($carModel->name); ?></option>
...
<?php echo $__env->make('customer.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Auto-Moly Vehicle Selling Website\auto-molly-web\resources\views/customer/pages/vehicles/create.blade.php ENDPATH**/ ?>