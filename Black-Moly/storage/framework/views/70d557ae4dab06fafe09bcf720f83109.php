            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="impl_facility_wrapper text-center">
                        <img src="<?php echo e(asset('images/services/ai-scanner.jpg')); ?>" alt="AI Scanner" class="img-fluid" />
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="impl_facility_wrapper text-center">
                        <img src="<?php echo e(asset('images/services/vehicle-score.jpg')); ?>" alt="Vehicle Score" class="img-fluid" />
                        <div class="impl_ser_hover_ovrly">
                            <div class="impl_ser_text">
                                <h3>Vehicle Score</h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="impl_facility_wrapper text-center">
                        <img src="<?php echo e(asset('images/services/price-prediction.jpg')); ?>" alt="Price Prediction AI" class="img-fluid" />
                        <div class="impl_ser_hover_ovrly">
                            <div class="impl_ser_text">
                ...
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6">
                            <div class="impl_facility_wrapper text-center">
                                <img src="<?php echo e(asset('images/services/secure-payment.jpg')); ?>" alt="Secure Transaction" class="img-fluid" />
                                <div class="impl_ser_hover_ovrly">
                                    <div class="impl_ser_text">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="impl_facility_wrapper text-center">
                                <img src="<?php echo e(asset('images/services/leasing-calculator.jpg')); ?>" alt="Leasing Calculator" class="img-fluid" />
                                <div class="impl_ser_hover_ovrly">
                                    <div class="impl_ser_text">
...
<?php echo $__env->make('customer.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Auto-Moly Vehicle Selling Website\auto-molly-web\resources\views/customer/pages/service.blade.php ENDPATH**/ ?>